...
public class King extends Piece {
     ...
     * @param x1    The current rank/x-position of the piece
     * @param y1    The current file/y-position of the piece
    ...
    private boolean checkAlongCastle(Player player, Square[][] board, int kx, int ky, int rx, int ry) {
        ...
        // insight: king and rook are on the same x but differnt y
        if (ry > ky) {
